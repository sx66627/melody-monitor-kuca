...
* Поддержка [модов](https://github.com/SuperZombi/melody-monitor/tree/main/mods).
...
Укажите никнейм, если хотите отправлять данные о прослушивании боту. Что бы можно было получить на канале twitch (должен совпадать с названием канала).
